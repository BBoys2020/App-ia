...
<head>
    ...
    <title>OmniMedia AI Pro - Local</title>
    <style>
        :root {
            --bg-dark: #090a0f;
            --bg-panel: #161b22;
        ...
        * { box-sizing: border-box; }
        ...
        button:hover:not(:disabled) { transform: scale(1.01); }
        ...
        .status-msg.success { background: rgba(46, 160, 67, 0.2); color: var(--success); display: block; }
